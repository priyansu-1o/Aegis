...
export default function LandingPage() {
  return <div className="landing-page">
    <header className="landing-nav"><div className="landing-wrap nav-row"><div className="ref-brand"><img src="/logo.svg" className="brand-mark" alt="Aegis Logo" /> AEGIS</div><Link className="nav-signin" to="/login">Sign In <span>→</span></Link></div></header>
    <main>
    ...
    <footer><div className="landing-wrap footer-row"><div className="ref-brand"><img src="/logo.svg" className="brand-mark" alt="Aegis Logo" /> AEGIS</div><span>Protection with dignity and care.</span></div></footer>
  </div>;
}
